...
#2 For which of the following tasks is a trie, or prefix tree most effective?
...
#3 What is the fundamental difference between a general tree and a Binary Tree?
