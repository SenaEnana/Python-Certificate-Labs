...
# 2.Which of the following is NOT a typical scenario that can be represented using a graph?

# temperature measurement over time
# transportation networks
# social networks
# communications networks
# 3.Which of the following terms describes an object or entity that is part of the network depicted by a graph?

# Node
# Endpoint
# CPU
# Cookie
# 4.Which of the following terms describes the connections between nodes in a graph?
...
# 6.Which of the following refers to a graph in which each node is associated with a label or identifier in addition to its data?

# Virtual labeled graph
# Vertex labeled graph
# Version labeled graph
# Vertical labeled graph
# 7.Which of the following refers to a directed graph with at least one cycle?
...
# 9.What is a directed acyclic graph?

# A directed graph with three cycles.
# A directed graph with one cycle.
# A directed graph with two cycles.
# A directed graph with no cycles.
# 10.Which of the following refers to a graph with two or more groups of nodes that are not connected by any edges?

# Disconnected graph
# Disconnection graph
# Disconnecting graph
# Disconnect graph
# 11.What is the Breadth-first search algorithm?
...
# 12.Which of the following algorithms will follow each branch as deep as possible before it backtracks?

# Daemon-First Search
# Dock-First Search
# Data-First Search
# Depth-First Search
# 13.Which of the following terms represents a two-dimensional list in which the rows and columns represent the graph's vertices?

# Adjacency matrix
# Array matrix
# Vertex matrix
# Depth matrix
# 14.Which of the following terms represents an array or dictionary that stores all the neighbors of each node?

# Tuple list
# Adjacency list
# Breadth list
# Cyclic list
# 15.What must be true for a graph to be classified as a tree?
...
# 16.Which of the following is a type of tree in which each node can have at most two child nodes?
...
# 18.How does the priority queue data structure differ from a regular queue data structure?
...
# 19.What are the two types of heaps?

# Max-heap and Min-heap
# Horizontal-heap and Vertical-heap
# Wide-heap and Tall-heap
# Breadth-heap and Depth-heap
# 20.What are the average and worst case time complexities for inserting and extracting the minimum or maximum value from a heap?
